        ...
        <main>
            <div class="jumbotron">
                <div class="jumbotron-text">
                    ...
                    <p> Nikmati Teknologi Yang Canggih Salah satunya Mobil Listrik</p>
                    ...
                    @foreach ($categories as $data)
                            ...
                            <div class="modal-dialog" onclick="event.stopPropagation()">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title " style="color:  black;">Formulir Pembayaran</h1>
                        ...
                        <div id="myModal2{{ $data->id_categories }}" class="modal-container"
                            ...
                            <div class="modal-dialog" onclick="event.stopPropagation()">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title" style="color:  black;">Data Transaksi</h1>
